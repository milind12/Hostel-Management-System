<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bill.aspx.cs" Inherits="DDUBOYSHOSTELMANAGEMENT.Bill" %>
...
<body >
    ...
    <div>
        <!-- <table class="table" style="color:white;margin-left:25%;margin-top:22%;width:50%">
        <tr>
            <td>Name :</td><td></td>
        </tr>
        <tr>
            <td>College Id</td><td></td>
        </tr>
        <tr>
            <td>Room no.</td><td></td>
        ...
        <tr><td>Credit card no.</td><td style="color:black">
            <asp:TextBox ID="TextBox1"  runat="server"  required="true"></asp:TextBox></td></tr>
        
        <tr><td>Expiry date</td><td style="color:black">
            <asp:TextBox ID="TextBox2" runat="server"  required="true"></asp:TextBox></td></tr>
        <tr><td>Secret pin</td><td style="color:black"><asp:TextBox ID="TextBox3" runat="server" required="true"></asp:TextBox></td></tr>
        ...
        <div class="WindowContainer" style=" padding: 0px;"><a name="Payment"></a>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="WindowMain" style="margin-top:9%">
		...
		<div class="WindowSub">
			...
			<tr>
			<td class="Left">Guardian Contact no.:</td>
...
<asp:PlaceHolder ID="PlaceHolder5" runat="server"></asp:PlaceHolder>				</td>
        ...
        -->     <asp:Button ID="Button1" runat="server" Text="Process Payment" class="BtnPay" OnClick="Button1_Click" ></asp:Button></td><td></td>
			...
			document.onkeydown=function(){ if(window.event.keyCode=='13'){ document.getElementById('BtnPay').value = 'Please Wait...'; document['Form1'].submit(); } }
			</script>
	...
	<div class="WindowLinks">
		...
		<a href="#" style="color:white" onclick="PoliciesToggle();">» VIEW MERCHANT POLICIES</a><br><br>
